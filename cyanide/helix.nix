  ...
  programs.helix = {
    ...
    themes = {
      yumeko = with palette; {
        ...
        "ui.statusline.select" = { fg = background; bg = orange_golden; modifiers = [ "bold" ]; };
        ...
        "ui.text" = text;
        "ui.text.focus" = { fg = g_2; bg = g_10; underline = { color = red_ember; style = "line"; }; modifiers = [ "bold" ]; };
        ...
        "ui.highlight" = { fg = orange_blaze; bg = cursorline; underline = { color = red_ember; style = "line"; }; modifiers = [ "bold" ]; };
